...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_kjh to login script."
...
# the current dir:
if   test x${GTLANG_kjh} = x ; then
	echo "WARNING: The variable \${GTLANG_kjh} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_kjh} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_kjh} has the value:"
	echo "  ${GTLANG_kjh}"
