...
This directory contains source files for the Khakas language morphology
...
In order to compile and use Khakas language morphology and dictionaries,
you need:
...
The Khakas language sources can be acquired using [giella SVN
